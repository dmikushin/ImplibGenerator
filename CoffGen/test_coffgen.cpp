...
int main() {
  ...
  relVar[0]->Set("dllName", id2, OFFSET(IMAGE_IMPORT_DESCRIPTOR, Name), 0,
                 RVARelocate);
  relVar[1] = fac->CreateRelocatableVar();
  relVar[1]->Set("FirstThunk", id2, OFFSET(IMAGE_IMPORT_DESCRIPTOR, FirstThunk),
                 4, RVARelocate);
  relVar[2] = fac->CreateRelocatableVar();
  relVar[2]->Set("OriginalFirstThunk", id2,
                 OFFSET(IMAGE_IMPORT_DESCRIPTOR, OriginalFirstThunk), 4,
                 RVARelocate);
  ...
  DWORD iatval = 0;
  coff->GetSymbolTableBuilder()->AddSymbol(id5, 0, "FirstThunk", SYST_STATIC,
                                           0);
  relVar[0] = fac->CreateRelocatableVar();
  ...
  coff->GetSymbolTableBuilder()->AddSymbol(id5, 0, "__imp__add@8", SYST_EXTERN,
                                           0);
  ...
  coff->GetSymbolTableBuilder()->AddSymbol(id4, 0, "OriginalFirstThunk",
                                           SYST_STATIC, 0);
  ...
  coff->GetSymbolTableBuilder()->AddSymbol(id7, 0, "LookUp_add", SYST_STATIC,
                                           0);
