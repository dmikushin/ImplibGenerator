...
namespace Sora {
    ...
    public:
        ...
        virtual void BuildImportByNameThunk(LPCSTR szDllName, LPCSTR szImpName, LPCSTR szFuncName, LPCSTR szDllExpName, ICoffBuilder*) = 0;
        virtual void BuildImportByOrdinalThunk(LPCSTR szDllName, LPCSTR szImpName, LPCSTR szFuncName, WORD szDllExpOrdinal, ICoffBuilder*) = 0;
        ...
        virtual void BuildImportThunk(LPCSTR szDllName, LPCSTR szImpName, LPCSTR szFuncName, LPCSTR szDllExpName, WORD nDllExpOrdinal, ICoffBuilder* cb) = 0;
    };
}
